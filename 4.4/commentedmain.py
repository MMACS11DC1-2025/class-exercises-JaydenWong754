...
def recursive_spiral(current_step, max_steps, counter=0):
    ...
    if current_step >= max_steps:
        return counter  #return how many time recursion called #TEST ERROR - for some reason, the way i counted before made the program draw 2 stars, so I had to spend lots of time debugging this
...
#output
print("Total recursion calls: " + str(total))  #count how many times recursion happend