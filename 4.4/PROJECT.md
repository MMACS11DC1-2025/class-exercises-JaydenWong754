...
- [  No] Test cases with expected vs actual results (2 pts)
- [ NO] Screenshots of visual outputs for each test case (2 pts)
...
- [No ] Comprehensive testing documentation (1 pt)
