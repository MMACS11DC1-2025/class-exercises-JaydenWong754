...
- [ yes] Clearly define the visual feature your program will detect and count (2 pts)
- [ yes] Justify your feature detection with an explanation of how your chosen feature can be accurately identified (3 pts)

### Image Processing and Feature Extraction (Unit 5)
#### Task 1: Pixels to Data Function
- [ yes] Write a function, is_target_feature, that accepts pixel data (e.g. colour channels as RGB tuple inputs) and returns a specific, useful output (e.g., returns True if the pixel matches your custom feature definition else False, or a weight) (10 pts)
#### Task 2: Pixel Iteration and List Building
- [ yes] Use nested loops to iterate over all pixels **in a set of at least 10 images** and calculate your "Feature Density Score" for each image (10 pts)
- [ yes] Append the filename and score to a master list, demonstrating list manipulation and the use of the append() method (5 pts)
...
- [ yes] Implement the Selection Sort algorithm function yourself (not using built-in libraries for sorting) to sort the master list based on the calculated Feature Density Score (highest to lowest) (12 pts)
- [ yes] Output the top 5 results using list slicing (3 pts)
#### Task 5: Binary Search
- [ yes] Implement the Binary Search algorithm function yourself to search the sorted list for a specific target score (10 pts)
...
### Version Control
- [ yes] Source code is committed to repository on Github with at least 5 meaningful commits on different days prior to deadline (10 pts)

## **QUALITY CRITERIA**
### Code Quality and Efficiency
- [ yes] Code quality: Clean, readable structure (2 pts)
- [ yes] Efficiency: Evidence of thinking about algorithmic complexity throughout the code (2 pts)
- [ yes] The program handles potential errors and edge cases effectively (2 pts)
- [ yes] Documentation polish: README is clear, concise, free of typos; also, code comments explain why decisions were made. (1 pt)

### Creativity and Originality
- [ yes] The chosen theme and visual feature are unique, interesting, and insightful (2 pts)
- [ yes] Feature detection uses a more advanced process, such as pre-processing the image, using multiple pixels, or using statistical approaches to detect features (4 points)
- [yes ] Captured feature involves a real-world use-case. References a real paper, report, or dataset supporting decisions for detecting feature (4 points)
